...
from sqlalchemy import Column, Integer, String, Float, Boolean, Date, ForeignKey, Table, Enum
...
class Vaga(Base):
    ...
    modalidade = Column(Enum(ModalidadeEnum))
    horario = Column(String)
    tipo_contrato = Column(Enum(TipoContratoEnum))
    publico_alvo = Column(Enum(PublicoAlvoEnum))
